...
const fetch = await _5ab‍.i('node-fetch');
const fs = require('fs');
  ...
  try {
    ...
    for (const culture of cultures) {
      ...
      if (brownPercentage < 15 && greenPercentage < 40) {
        const updatedImageUrlArray = [imageUrl]; // Create an array with a single image URL
    ...
    _5ab‍.g.console.error('Error executing query', error);
  }
}
